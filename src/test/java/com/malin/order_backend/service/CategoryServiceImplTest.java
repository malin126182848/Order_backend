...
import com.malin.order_backend.service.impl.CategoryServiceImpl;
...
public class CategoryServiceImplTest {
    ...
    public void findByCategoryType() throws Exception {
        ProductCategory productCategory = categoryService.findByCategoryType(2);
        Assert.assertNotEquals("", productCategory.getCategoryName());
    }
